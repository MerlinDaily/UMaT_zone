...
import 'package:umat_zone/Screens/Home/Mobilepages/Mcomments_screen.dart';
import 'package:umat_zone/Screens/Home/Mobilepages/Meditpost.dart';
import 'package:umat_zone/Screens/Platforms/WebSceens/Webed.dart';
import 'package:umat_zone/Services/Firestoremethods.dart';
import 'package:umat_zone/shared/Pop_up.dart';
import 'package:umat_zone/shared/Widgets/like_animation.dart';
              ...
              SimpleDialogOption(
                ...
                onPressed: () async {
                  String ress = await FirestoreMethods()
                      .Deletepost(widget.snap['Post Uid']);
