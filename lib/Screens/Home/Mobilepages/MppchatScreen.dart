...
import 'package:umat_zone/Screens/Home/Mobilepages/MpChatbody.dart';
              ...
              child: Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintStyle:
                        TextStyle(color: Color(themedata.BottomNavTextColor)),
                    border: InputBorder.none,
                  ),
                  style: TextStyle(color: Color(themedata.BottomNavTextColor)),
                ),
              ),
            ),
            ElevatedButton(
              onPressed: () async {
                if (text.text != "") {
                  ...
                  String? ress = await FirestoreMethods().Sendmessage(
                      user1.Username!,
                      user1.UID!,
                      widget.snap['username'],
                      widget.snap['uid'],
