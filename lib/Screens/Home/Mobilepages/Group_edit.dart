...
class _GeditState extends State<Gedit> {
  ...
  void initState() {
    super.initState();
    widget.snap["Group Name"] != null
        ? groupname.text = widget.snap["Group Name"]
        : groupname.text = "";
    widget.snap["Group Description"] != null
        ? groupdesc.text = widget.snap["Group Description"]
        : groupdesc.text = "";
    widget.snap["Identity"] != null
        ? memalias.text = widget.snap["Identity"]
        : memalias.text = "";
    widget.snap["Post Name"] != null
        ? postalias.text = widget.snap["Post Name"]
        : postalias.text = "";
  }
              ...
              SimpleDialogOption(
                ...
                onPressed: () async {
                  await FirestoreMethods()
                      .Deletegroup(widget.snap["Group Uid"]);
                  setState(() {
                    pop = true;
                  });
                  Navigator.of(context).pop();
                      ...
                      onPressed: () async {
                        ...
                        if (image != null) {
                          String content = await FirestoreMethods()
                              .UpdateHeader(widget.snap['Group Uid'], image2);
                    ...
                    child: GestureDetector(
                      ...
                      child: CircleAvatar(
                        ...
                        backgroundImage: image == null
                            ? NetworkImage(widget.snap['Group Pic'])
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    if (groupdesc.text == "" ||
                      ...
                      String content = await FirestoreMethods().UpdateGroup(
