...
import 'package:umat_zone/shared/Widgets/Groupcommentcard.dart';
...
class _GcommentsScreenState extends State<GcommentsScreen> {
  ...
  commenting(String groupid, String postid, String textt, String author_uid,
      String author, String ppurl, String title, String onweruid) async {
    String ress = await FirestoreMethods()
        .Groupcomment(groupid, postid, textt, author_uid, author, ppurl);
