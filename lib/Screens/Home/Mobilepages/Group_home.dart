...
import 'package:umat_zone/Screens/Home/Mobilepages/GMember_list.dart';
import 'package:umat_zone/Screens/Home/Mobilepages/Group_Post.dart';
import 'package:umat_zone/Screens/Home/Mobilepages/Group_chat.dart';
import 'package:umat_zone/Screens/Home/Mobilepages/Group_edit.dart';
...
import 'package:umat_zone/shared/Widgets/Gpostcard.dart';
          ...
          IconButton(
            onPressed: () {
              if (widget.snap['Members'].contains(user1.UID) == true) {
                ...
                Showsnackbar(
                    "Access Denied, please join colony first", context);
              }
            },
            ...
            children: [
                  ...
                  Positioned(
                    ...
                    child: IconButton(
                      onPressed: () async {
                        ...
                        if (image != null) {
                          String content = await FirestoreMethods()
                              .UpdateHeader(widget.snap['Group Uid'], image);
                      ...
                      icon: FaIcon(
                        ...
                        size: 50,
                        color: widget.snap['author uid'] == user1.UID &&
                                widget.snap['Header'] == ""
                            ? Color(themedata.ScaffoldbuttonIconColor)
                            : Colors.transparent,
                      ),
                    ),
                  ),
              ...
              Row(
                ...
                children: [
                  ...
                  widget.snap['Members'].contains(user1.UID)
                      ? ElevatedButton(
                          onPressed: () async {
                            String content = await FirestoreMethods()
                                .Leavegroup(widget.snap['Group Uid'], user1);
                            Showsnackbar(content, context);
                            Navigator.of(context).pop();
                          },
                          child: Row(
                      ...
                      : ElevatedButton(
                          onPressed: () async {
                            String content = await FirestoreMethods()
                                .JoinGroup(widget.snap['Group Uid'], user1);
                            Showsnackbar(content, context);
                            setState(() {});
                          },
                          child: const Text(
